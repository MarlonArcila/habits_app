    ...
    <header className="sticky top-0 z-50 w-full border-b bg-background/95 backdrop-blur supports-[backdrop-filter]:bg-background/60">
      <div className="container flex h-16 items-center justify-between px-4">
        <div className="flex items-center">
          <svg width="32" height="32" viewBox="0 0 100 100" className="mr-2 fill-primary h-7 w-7 sm:h-8 sm:w-8">
          ...
          <h1 className="text-xl sm:text-2xl font-bold tracking-tight text-primary">Habitual</h1>
        </div>
        <div className="flex items-center gap-1 sm:gap-2">
          ...
          <Button onClick={onAddHabitClick} size="sm" className="px-2 sm:px-3">
